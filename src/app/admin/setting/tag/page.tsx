...
import StoreListTable from "./ui/TagListTable";
import { getTagList } from "./model/tagApi";
import TagListTable from "./ui/TagListTable";
  ...
  return (
    <div className="flex flex-row h-screen select-none">
      ...
      >
        ...
        <TagListTable items={data ? data : []} onRefresh={refresh} loading={loading} selectedId={selectedId} onSelect={onSelectId} />
      </div>
      ...
      >
        {(selectedId&&
         <iframe
          src={'/admin/setting/tag/' + selectedId}
          width="100%"
          height="100%"
          style={{ border: 'none' }}
