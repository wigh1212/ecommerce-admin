...
import { getBannerList } from "./model/bannerApi";
import BannerListTable from "./ui/BannerListTable";
...
export default function Banner() {
  ...
  return (
    <div className="flex flex-row h-screen select-none">
      ...
      >
        <h1 className="text-2xl font-bold mb-4">배너 리스트</h1>
        <BannerListTable items={data ? data : []} onRefresh={refresh} loading={loading} selectedId={selectedId} onSelect={onSelectId} />
      </div>
      ...
      >
        {(selectedId&&
         <iframe
          src={'/admin/setting/banner/' + selectedId}
          width="100%"
          height="100%"
          style={{ border: 'none' }}
